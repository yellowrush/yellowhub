...
export default function TimeWidget() {
  ...
  // Use rAF to defer setState so oxlint's set-state-in-effect stays happy
  useEffect(() => {
    const raf = requestAnimationFrame(() => setMounted(true));
    const id = setInterval(() => setNow(new Date()), 1001);
    return () => {
    ...
    return (
      <div className="time-widget time-widget--float">
        ...
        <div className="time-widget__clouds">
          <svg
            className="time-widget__cloud time-widget__cloud--1"
            viewBox="0 0 80 36"
            fill="none"
            xmlns="http://www.w3.org/2000/svg"
          >
            <path
              d="M16 28c-6 0-10-4-10-9s4-8 9-8c1-5 6-9 12-9 5 0 9 3 10 7 2-1 4-2 6-2 5 0 9 4 9 8s-4 8-9 8H16z"
              fill="currentColor"
              opacity="0.45"
            />
          </svg>
          <svg
            className="time-widget__cloud time-widget__cloud--2"
            viewBox="0 0 60 28"
            fill="none"
            xmlns="http://www.w3.org/2000/svg"
          >
            <path
              d="M12 22c-5 0-8-3-8-7s3-6 7-6c1-4 5-7 9-7 4 0 7 2 8 6 1-1 3-2 5-2 4 0 7 3 7 7s-3 6-7 6H12z"
              fill="currentColor"
              opacity="0.3"
            />
          </svg>
          <svg
            className="time-widget__cloud time-widget__cloud--3"
            viewBox="0 0 50 22"
            fill="none"
            xmlns="http://www.w3.org/2000/svg"
          >
            <path
              d="M10 18c-4 0-7-3-7-6s3-5 6-5c1-3 4-6 8-6 3 0 6 2 7 5 1-1 2-1 4-1 3 0 6 2 6 5s-3 5-6 5H10z"
              fill="currentColor"
              opacity="0.35"
            />
          </svg>
  ...
  return (
    <div className="time-widget time-widget--float">
      ...
      {/* Clock face */}
      <div className="time-widget__clock">
        <span className="time-widget__hm">
